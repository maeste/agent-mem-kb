...
## [2026-07-02] ingest | Batch 5: 15 sorgenti create/aggiornate da raw/papers/ non ancora processati. Nuove sorgenti: arxiv-2604.27707 (Xu et al., critica memoria=lookup), arxiv-2604.27283 (Iscan, RSCB-MC risk-sensitive retrieval), hu-2026-continual-learning-memory (Hu, CL via memory reuse), li-2026-ocr-memory (Li, optical context retrieval), wu-2026-contextweaver (Wu, dependency-structured memory), abtahi-2026-memanto (Abtahi, typed semantic memory), cai-2026-proactagent (Cai, proactive retrieval), gu-2026-fsfm (Gu, selective forgetting), simsek-2026-when-to-forget (Simsek, memory worth primitive), zhang-2026-lightmem (Zhang, lightweight SLM memory), du-2026-memory-survey (Du, survey meccanismi+evaluation), actmem (Zhang, retrieval+reasoning gap), xu-2026-agent-skills-survey (Xu&Yan, skills survey), xia-2026-skill-rl (Xia, skill RL recursive evolution), ling-2026-agent-skills-analysis (Ling, empirical skills analysis). Aggiornato xu-2026-contextual-agentic-memory con versione estesa.
---
