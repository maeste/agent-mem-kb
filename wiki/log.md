...
## [2026-05-25] ingest | Verificati 24 paper raw/papers/ senza corrispondenza diretta per slug arxiv. Risultato: tutti avevano gia entry wiki/sources/ con slug nominativo (creata in batch precedenti). Unica nuova entry: arxiv-2604.27003 (Hu et al., NTU — continual learning via memory reuse). Aggiornate da stub a contenuto completo: li-2026-ocr-memory e wu-2026-contextweaver. Aggiornato index.md.
## [2026-05-25] reflect | Compass settimanale (lunedi)
