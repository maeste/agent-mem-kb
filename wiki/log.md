...
## [2026-06-29] sync | Vault sincronizzata da main. Nessun nuovo contenuto in inbox, nessun paper senza source entry (tutti i 27 PDF in raw/papers/ hanno già corrispondente wiki/sources/).
## [2026-06-29] reflect | compass.md riscritto: vault ferma dal 5 maggio, quasi due mesi di silenzio. Segnalate view mancanti, pagina Xu et al. mai costruita, 4 pagine su 6 ferme al batch iniziale. hot.md aggiornato.
---
