...
## [2026-06-04] sync | Pull da main dopo un mese di inattività. Nessuna novità in inbox.md (0 unchecked).
## [2026-06-04] ingest | Verificati 25 paper raw/papers/ senza entry wiki/sources/ arxiv-slug: tutti duplicati di entry nominate esistenti (es. arxiv-2507.07957 = wang-2025-mirix). 25 file arxiv-*.md creati e immediatamente rimossi. Nessun nuovo contenuto da processare.
## [2026-06-04] reflect | compass.md riscritta: focus sul mese di stasi (5 maggio → 4 giugno), view mai costruite, critica Xu senza pagina, tensione skill auto-generate non sintetizzata. hot.md aggiornato.
---
