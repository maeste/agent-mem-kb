...
## [2026-06-22] sync | Vault sincronizzata con remote. Inbox vuoto (0 unchecked items). Tutti i 26 paper in raw/papers/ hanno già corrispondente sorgente in wiki/sources/ (con slug basato sull'autore). Nessun nuovo contenuto da ingestire.
## [2026-06-22] reflect | compass.md riscritto: focus sulla tensione astrazione vs granularità, stato di stasi della vault (ferma dal 5 maggio), pagine da aggiornare con sorgenti non integrate, view mai costruite. hot.md aggiornato.
---
