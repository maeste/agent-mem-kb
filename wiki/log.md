...
## [2026-06-13] lint | LINT settimanale (sabato): 0 blocking, 0 important, 10 advisory (gap euristici falsi positivi). Tentato ingest di 10 paper raw/papers/ senza wiki/sources/: tutti erano gia presenti con slug nominali (es. arxiv-2604.27707 = xu-2026-contextual-agentic-memory). Rimangono 13 paper in raw/papers/ senza source entry da processare in batch futuri. Inbox vuota, nessuna novita da fetch.
---
