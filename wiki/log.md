...
## [2026-05-16] sync | Vault sincronizzata da remote. Inbox vuota (0 unchecked items). Tutti i 25 paper in raw/papers/ hanno già corrispondente entry wiki/sources/ (convenzione author-year). Nessun nuovo contenuto da ingestire.
## [2026-05-16] lint | Lint settimanale (sabato). Risultato: 0 blocking, 0 important, 10 advisory (gap concettuali attesi). Vault pulita.
---
