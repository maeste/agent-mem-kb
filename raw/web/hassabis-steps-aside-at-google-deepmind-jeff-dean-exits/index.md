---
source_url: https://www.implicator.ai/google-deepmind-hassabis-steps-aside-jeff-dean-exit/
title: Hassabis Steps Aside at Google DeepMind, Jeff Dean Exits
...
hostname: implicator.ai
description: Demis Hassabis is handing over day-to-day control of Google DeepMind, and Jeff Dean is leaving after 27 years to run a startup Google is investing in. Alphabet shares fell more than 5%, a reading that sits awkwardly beside the company's own account of the day.
sitename: Implicator.ai
date: "2026-08-05"
categories: ['AI News']
tags: ['AI News']
---
...
The reaction arrived while Alphabet was already spending heavily on the computing infrastructure behind its AI plans. In its latest reported quarter, Google turned cash flow negative for the first time on record because of capital expenditure, while forecasting as much as $205 billion in capital spending for full-year 2026, [CNBC reported](https://www.cnbc.com/2026/08/05/google-chief-scientist-jeff-dean-leaving-company-after-27-years.html?ref=implicator.ai). One trading session cannot show how much of the decline investors assigned to the departures rather than that spending.
...
[Nobel Laureate John Jumper Leaves Google DeepMind for AnthropicJohn Jumper, who shared the 2024 Nobel Prize in chemistry for the AlphaFold protein-prediction model, will leave Google DeepMind to join Anthropic, both companies confirmed Friday. Jumper announced th](https://www.implicator.ai/nobel-laureate-john-jumper-leaves-google-deepmind-for-anthropic/)

![](assets/249541755f55.webp)

[China's AI talent is going home. The real blow is the students who stopped leaving.Shorts and flip-flops, in a Shenzhen conference room, in November. Not exactly the dress code at Tencent. But Yao Shunyu was 27, had arrived on a plane out of San Francisco a few weeks earlier with an](https://www.implicator.ai/chinas-ai-talent-is-going-home-the-real-blow-is-the-students-who-stopped-leaving-2/)

![](assets/98cc19e1155f.webp)

[Bezos's Project Prometheus Hires xAI Co-Founder as Musk Loses Entire Founding TeamKyle Kosic, who co-founded Elon Musk's xAI and built the infrastructure behind its Colossus supercomputer, has left OpenAI to join Jeff Bezos's secretive AI startup Project Prometheus, the Financial T](https://www.implicator.ai/bezoss-project-prometheus-hires-xai-co-founder-as-musk-loses-entire-founding-team/)

![](assets/7e2fcfdf2325.webp)
