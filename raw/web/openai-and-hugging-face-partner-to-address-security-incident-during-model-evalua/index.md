...
hostname: openai.com
description: OpenAI and Hugging Face share early findings from a security incident during AI model evaluation, highlighting advanced cyber capabilities and lessons for defenders.
sitename: OpenAI
date: 2026-07-21
---
# OpenAI and Hugging Face partner to address security incident during model evaluation
...
![Chart from the UK AI Security Institute comparing recent open-weight models and frontier models on long-horizon cyber ranges.](assets/f2bf89be1436.png)
