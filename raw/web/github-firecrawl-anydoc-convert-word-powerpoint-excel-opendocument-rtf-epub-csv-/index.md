...
title: "GitHub - firecrawl/anydoc: Convert Word, PowerPoint, Excel, OpenDocument, RTF, EPUB, CSV, and PDF to clean Markdown. Built in Rust, with Node.js and Python bindings."
author: Firecrawl
...
hostname: github.com
description: Convert Word, PowerPoint, Excel, OpenDocument, RTF, EPUB, CSV, and PDF to clean Markdown. Built in Rust, with Node.js and Python bindings. - firecrawl/anydoc
sitename: GitHub
date: "2026-08-03"
categories: ['repository:1322012299']
---




Fast Rust library that converts documents (Word, PowerPoint, Excel, OpenDocument, RTF, EPUB, CSV, and PDF) into clean GitHub-Flavored Markdown. Includes bindings for [Node.js](https://github.com/firecrawl/anydoc/blob/main/node/README.md), [Python](https://github.com/firecrawl/anydoc/blob/main/python/README.md), and the [browser](https://github.com/firecrawl/anydoc/blob/main/wasm/README.md) (WebAssembly).
...
The [skill](https://github.com/firecrawl/anydoc/blob/main/skills/convert-documents-to-markdown/SKILL.md) teaches the agent to convert documents with the anydoc CLI. Works with [Claude Code](https://claude.ai/code), [Codex](https://openai.com/codex/), [Cursor](https://cursor.com), [OpenCode](https://opencode.ai), and any other [compatible agent](https://agentskills.io/clients).
...
```
Full API reference: [node/README.md](https://github.com/firecrawl/anydoc/blob/main/node/README.md)
...
```
Full API reference: [python/README.md](https://github.com/firecrawl/anydoc/blob/main/python/README.md)
...
```
Full API reference: [wasm/README.md](https://github.com/firecrawl/anydoc/blob/main/wasm/README.md)
...
- **Agent ready.** Ships as an[Agent Skill](https://github.com#agent-skill) : one`npx skills add firecrawl/anydoc` and any agent can read office documents.
...
```
A committed fixture corpus under `tests/fixtures/` is snapshot-tested, `tests/robustness.rs` mutation-tests every fixture, and `fuzz/` carries cargo-fuzz targets per format. The speed and quality benchmark lives in [`bench/`](https://github.com/firecrawl/anydoc/blob/main/bench/README.md).

Releases are tagged `v<version>`, which publishes the crate, the npm package, and the PyPI wheels from [`.github/workflows/release.yml`](https://github.com/firecrawl/anydoc/blob/main/.github/workflows/release.yml). The version lives in three places, bumped together for a release:

- [`Cargo.toml`](https://github.com/firecrawl/anydoc/blob/main/Cargo.toml) : the crate
- [`node/package.json`](https://github.com/firecrawl/anydoc/blob/main/node/package.json) : the npm package
- [`python/Cargo.toml`](https://github.com/firecrawl/anydoc/blob/main/python/Cargo.toml) : the wheel (`python/pyproject.toml` reads it)
