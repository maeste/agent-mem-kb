...
hostname: meta.ai
description: Introducing Muse Code, a terminal coding agent powered by Muse Spark 1.2, with persistent background agents, repository-scale execution, and built-in verification.
sitename: Meta AI Research
date: "2026-08-05"
tags: ['AI systems', 'Language models', 'Evaluation']
---
# Introducing Muse Code and Muse Spark 1.2
...
![Bar chart comparing Terminal-Bench 2.1 scores for Muse Spark 1.2 and other coding models.](assets/885ad88bc59c.png)

![Bar chart comparing DeepSWE 1.1 scores for Muse Spark 1.2 and other coding models.](assets/4bef7fecf83c.png)

![Bar chart comparing Meta Internal Coding Bench scores for Muse Spark 1.2 and other coding models.](assets/d7b27f485b29.png)
...
![Chart comparing KDA kernel speedup against the baseline over cumulative tool calls for Muse Spark 1.2 and other models.](assets/8abcfe98aeaf.png)
