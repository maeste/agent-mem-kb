...
---
title: "Prime Agent: A self-improving RLM agent"
url: https://primeintellect.ai/blog/prime-agent
hostname: primeintellect.ai
description: "Prime Agent is our open-source, self-improving coding harness built around two abstractions: the Recursive Language Model (RLM) and the Continual Harness. With Opus 5, it achieves 95.5% on ARC-AGI-3, surpassing the reported human expert baseline."
sitename: primeintellect.ai
date: "2026-08-05"
---
# Prime Agent: A self-improving RLM agent

[Seth Karten](https://x.com/sethkarten)

[Alex L. Zhang](https://x.com/a1zhang)

[Kevin Thomas](https://x.com/kevinjosethomas)

[Sebastian Müller](https://x.com/omouamoua)

[Prime Intellect Team](https://x.com/primeintellect)

![Prime Agent: A self-improving RLM agent](assets/de0dae576178.png)
...
```
![Prime Agent onboarding splash screen](assets/4fe519ceda62.gif)
...
![Prime Agent architecture diagram](assets/c1b385164aea.png)
...
![Prime Agent text user interface](assets/752cc5c1d4a0.png)
...
![Prime Agent Agents View listing running, idle, and inactive sessions](assets/d4b582ba0cd7.png)
...
![Prime Agent playing Factorio with four controllable characters](/blog/prime-agent/factorio.png)
